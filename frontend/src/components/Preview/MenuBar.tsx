    ...
    return (
        <div
            ...
            <Button
                ...
                className={viewMode === 'grid' ? activeButtonClass : inactiveButtonClass}
                title="Grid View">
                <BsGrid className="w-5 h-5" />
            </Button>
            <Button
                onClick={() => setViewMode('single')}
                className={viewMode === 'single' ? activeButtonClass : inactiveButtonClass}
                title="Single View">
                <BsFillFileImageFill className="w-5 h-5" />
            </Button>
            <Button
                onClick={() => setViewMode('3d')}
                className={viewMode === '3d' ? activeButtonClass : inactiveButtonClass}
                title="3D View">
                <BsFillLayersFill className="w-5 h-5" />
            </Button>
            {viewMode === '3d' && (
                <>
                    <Button
