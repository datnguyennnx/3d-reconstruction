...
import { ModelProps, ModelDetails, ModelLoadState } from './types'
...
export const Model: React.FC<ModelProps> = ({
    ...
    const validateModelFile = useCallback(async (fileUrl: string) => {
        try {
        ...
        return (
            <group ref={modelRef}>
                <mesh>
                    ...
                    <meshBasicMaterial color={loadState.status === 'error' ? "red" : "blue"} wireframe />
                </mesh>
                <Text
                    position={[0, 1, 0]}
                    fontSize={0.2}
