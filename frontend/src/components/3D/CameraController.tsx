...
import { type CameraConfig, type CameraControllerProps, type ModelDetails } from './types'
    ...
    ({ config = {}, modelSize }, ref) => {
        ...
        useImperativeHandle(ref, () => ({
            ...
            zoomToFit: (boundingBox?: THREE.Box3) => {
                ...
                if (controls && boundingBox && isPerspectiveCamera(camera)) {
                    ...
                    const newPosition = center.clone().add(new THREE.Vector3(0, 0, distance))
        ...
        const adaptiveCameraConfig = useCallback(() => {
            if (modelSize) {
                ...
                return {
                    initialPosition: [baseDistance, baseDistance, baseDistance] as [
                        number,
                        number,
                        number,
                    ],
        ...
        const setupCameraControls = useCallback(() => {
            ...
            if (controls) {
                ...
                controls.target.lerp(
                    ...
                    mergedConfig.smoothingFactor ?? 0.2,
                )
