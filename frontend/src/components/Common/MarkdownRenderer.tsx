...
export const MarkdownRenderer: React.FC<MarkdownRendererProps> = ({ 
    ...
    const handleGenerate3DModel = useCallback(async (sourceUrl: string) => {
    ...
    const components: Components = useMemo(() => ({
        ...
        h2: ({ ...props }) => <h2 className="text-2xl font-semibold my-0 text-indigo-700" {...props} />,
        h3: ({ ...props }) => <h3 className="text-xl font-medium my-0 text-indigo-600" {...props} />,
        h4: ({ ...props }) => <h4 className="text-lg font-medium my-0 text-indigo-500" {...props} />,
        p: ({ ...props }) => (
            <p 
